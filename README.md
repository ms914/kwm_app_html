This is a **KWM (Kimball/Kugelwolkenmodell/Valence-shell Molecular) MVP** — a 3D molecular builder built in Three.js with a clean 4-layer architecture (Data → Logic → Renderer → Controller).
